...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        ...
        # Q-values: dicionario com valor padrao 0.0, indexado por (state, action)
    ...
    def computeActionFromQValues(self, state):
        ...
        # Junta todas as acoes com Q-value maximo e desempata aleatoriamente
    ...
    def getAction(self, state):
        ...
        if not legalActions:
            return None
        # Com probabilidade epsilon: explora (acao aleatoria);
        # senao: escolhe a melhor acao segundo os Q-values
